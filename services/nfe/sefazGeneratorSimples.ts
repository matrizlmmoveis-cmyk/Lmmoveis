...
export class SEFAZTxtGeneratorSimples {
    ...
    public static generate(
        ...
        items.forEach((item, index) => {
            ...
            lines.push(`H|${nItem}||`);
            // I - Detalhes do Produto (Fidelidade à Skill - CFOP na coluna 8)
            ...
            if (taxRegime === 1) {
                // Simples Nacional 102 (Igual ao XML validado com sucesso)
                lines.push(`N|`);
                lines.push(`N10d|0|102|`);
                lines.push(`Q|`);
                lines.push(`Q05|99|0.00|0.0000|0.00|`);
                lines.push(`S|`);
                lines.push(`S05|99|0.00|0.0000|0.00|`);
            } else {
        ...
        // W - Totais (Fidelidade à Skill - Layout 21 campos)
